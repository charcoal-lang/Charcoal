...
ASTProcessor = {
    ...
    CT.Multidirectional: [
        ...
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up right, down right, down left, up left"] + r[1][0](s)[1:]],
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up, up right, right, down right, down, down left, left, up left"] + r[1][0](s)[1:]],
        ...
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up right, down left"] + r[1][0](s)[1:]],
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up right, down right"] + r[1][0](s)[1:]],
        ...
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up, up right, down right, down"] + r[1][0](s)[1:]],
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up, right"] + r[1][0](s)[1:]],
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Right, down, left"] + r[1][0](s)[1:]],
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up right, up left"] + r[1][0](s)[1:]],
        lambda r: [lambda s="": [r[1][0](s)[0], r[0] + ": Up right, down, up left"] + r[1][0](s)[1:]],
