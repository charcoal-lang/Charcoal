...
VerboseGrammars = {
    ...
    CT.Command: [
        ...
        [
            "MapAssignLeft", CT.LP, CT.Binary, CT.Separator, CT.Expression,
            CT.Name, CT.RP
        ],
        [
            "MapAssignRight", CT.LP, CT.Binary, CT.Separator, CT.Expression,
            CT.Name, CT.RP
        ],
        ["MapAssign", CT.LP, CT.Unary, CT.Separator, CT.Name, CT.RP],
